...
function hook_lti_tool_provider_launch() {
  ...
  // Invoked after user provisioned, authenticated and authorized, and course group provisioned,
  //   but before redirect to landing page.
  // LTI context variables are available in $_SESSION['lti_tool_provider_context_info'].
}
